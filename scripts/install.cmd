...
set "MOD_CONTROLS=Controls: Home=Recenter, End=Toggle, PgUp=Cycle tracking mode, PgDn=Toggle yaw mode. No nav cluster? Ctrl+Shift+ T=Recenter Y=Toggle G=Mode H=Yaw"
