@echo off
:: ============================================
:: Control: Ultimate Edition Head Tracking - Install
:: ============================================
...
:: --- CONFIG BLOCK ---
set "GAME_ID=control-ultimate-edition"
set "MOD_DISPLAY_NAME=Control: Ultimate Edition Head Tracking"
set "MOD_DLLS=ControlHeadTracking.asi"
set "MOD_INTERNAL_NAME=ControlHeadTracking"
set "MOD_VERSION=0.0.0"
set "STATE_FILE=.headtracking-state.json"
set "FRAMEWORK_TYPE=ASILoader"
set "ASI_LOADER_NAME=winmm.dll"
set "MOD_CONTROLS=Controls: End=Toggle, PgUp=Cycle tracking mode, PgDn=Toggle yaw mode. No nav cluster? Ctrl+Shift+ Y=Toggle G=Mode H=Yaw"
